...
const FEATURES = [
  ...
  { key: 'overtime_grid', icon: '📋', label: '残業申請「表入力」', note: '残業の申請・報告を、給与期間1か月ぶんの表でまとめて入力して送れる入口。パソコンで開いたときだけ出ます。送った申請は1件ずつの申請と同じ流れで受理されます。OFFの役職にはボタンが出ません', group: '勤怠・時間' as FeatureGroup, bySuperior: false },
