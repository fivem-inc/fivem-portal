...
【Supabaseのデータ保全＝まだ実装していない（次回の本題）】
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
■ バックアップ設計の要点（レビュー2体の指摘・実装時に必ず読む）
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
■ 次にやること（優先順）
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
0.【実装・次回の本題】**Supabaseのデータのバックアップ**（無料プランは復元手段が一切ない）
   Phase2: pg_dump を配置（PostgreSQL 17系のzip版のbinだけ。本体のインストールは不要）
   Phase3: 日次スクリプト（読み取り専用ロール／7-Zip暗号化／世代14日／**中身**の検証）
   Phase4: 年1回の復元リハーサルを手順書に明記
   🚨 着手前に上の「■ バックアップ設計の要点」を必ず読む（storage cpの構文・
      auth除外・JSONでは復元不可・検証は中身で、など踏みやすい落とし穴が並んでいる）
